...
<img border="0" src="images/gripblue.gif" width="15" height="19"></td>
    <td width="*" bgcolor="#6699CC" bordercolor="#6699CC" valign="middle"><b><font color="#FFFFFF" size="2" face="Verdana">Newsletter</font></b></td>
...
select case request.querystring("action")
	case "send":
		%><!-- #include file="newsletter/send.asp" --><%
	case else
		%><!-- #include file="newsletter/home.asp" --><%
end select
%>
</td></tr>
</table>
