...
<img border="0" src="images/gripblue.gif" width="15" height="19"></td>
    <td width="*" bgcolor="#6699CC" bordercolor="#6699CC" valign="middle"><b><font color="#FFFFFF" size="2" face="Verdana">Manufacturers</font></b></td>
...
<tr>
  ...
  select case action
  	case "add":
		%><!-- #include file="manufacturers/add.asp" --><%
	case "edit":
		%><!-- #include file="manufacturers/edit.asp" --><%
	case "delete":
		%><!-- #include file="manufacturers/delete.asp" --><%
	case else
		%><!-- #include file="manufacturers/home.asp" --><%
  end select
  %>
  </td>
</tr>
