...
<img border="0" src="images/gripblue.gif" width="15" height="19"></td>
    <td width="*" bgcolor="#6699CC" bordercolor="#6699CC" valign="middle"><b><font color="#FFFFFF" size="2" face="Verdana">Payments</font></b></td>
...
select case request.querystring("action"):
	case "edit":
		%><!-- #include file="payments/edit.asp" --><%
	case "add":
		%><!-- #include file="payments/add.asp" --><%
	case "paypal":
		%><!-- #include file="payments/paypal.asp" --><%
	case "ogone":
		%><!-- #include file="payments/ogone.asp" --><%
	case else
		%><!-- #include file="payments/home.asp" --><%
end select
%>
</td></tr>
</table>
