<center><br><br>
<table border="0" width="716" bordercolor="#6699CC" cellspacing="0" cellpadding="0">
<tr>
<td width="16" bgcolor="#6699CC" bordercolor="#6699CC">
<img border="0" src="images/gripblue.gif" width="15" height="19"></td>
    <td width="*" bgcolor="#6699CC" bordercolor="#6699CC" valign="middle"><b><font color="#FFFFFF" size="2" face="Verdana">Custom 
      page </font></b></td>
...
<tr>
		...
		select case action
			case "add":
				%><!-- #include file="custompage/add.asp" --><%
			case "edit":
				%><!-- #include file="custompage/edit.asp" --><%
			case "delete":
				%><!-- #include file="custompage/delete.asp" --><%
			case else
				%><!-- #include file="custompage/home.asp" --><%
		end select
		%>
		</td>
</tr>
