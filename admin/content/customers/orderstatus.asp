...
<td width="*" bgcolor="#6699CC" bordercolor="#6699CC" valign="middle"><b><font color="#FFFFFF" size="2" face="Verdana">Order Status</font></b></td>
...
select case request.querystring("action")
	case "add":
		%><!-- #include file="orderstatus/add.asp" --><%
	case "edit":
		%><!-- #include file="orderstatus/edit.asp" --><%
	case "delete":
		%><!-- #include file="orderstatus/delete.asp" --><%
	case else
		%><!-- #include file="orderstatus/home.asp" --><%
end select
%>
</td></tr>
</table>
