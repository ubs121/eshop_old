...
<td width="*" bgcolor="#6699CC" bordercolor="#6699CC" valign="middle"><b><font color="#FFFFFF" size="2" face="Verdana">Orders</font></b></td>
...
select case request.querystring("action")
	case "edit":
		%><!-- #include file="orders/edit.asp" --><%
	case else
		%><!-- #include file="orders/home.asp" --><%
end select
%>
</td></tr>
</table>
