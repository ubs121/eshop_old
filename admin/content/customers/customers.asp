...
<td width="*" bgcolor="#6699CC" bordercolor="#6699CC" valign="middle"><b><font color="#FFFFFF" size="2" face="Verdana">Customers</font></b></td>
...
select case request.querystring("action")
	case "edit":
		%><!-- #include file="customers/edit.asp" --><%
	case "addressbook":
		%><!-- #include file="customers/addressbook.asp" --><%
	case else
		%><!-- #include file="customers/home.asp" --><%
end select
%>
</td></tr>
</table>
